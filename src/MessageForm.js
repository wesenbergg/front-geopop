...
const MessageForm = ({ markerState, formState }) => {
  ...
  return(
    <div className={form ? "": "d-none"}>
      <h3 className="pt-4 pl-3 pb-3 mb-0 inbox-h">New Pop message</h3>
      <form id="NewMessage" autoComplete='off' className="pr-2 pl-2 custom-scroll" onSubmit={e => handleSubmit(e)}>
